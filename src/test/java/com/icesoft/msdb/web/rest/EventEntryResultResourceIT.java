...
/**
 * Integration tests for the {@link EventEntryResultResource} REST controller.
 */
@SpringBootTest(classes = MotorsportsDatabaseApp.class)
public class EventEntryResultResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static EventEntryResult createUpdatedEntity(EntityManager em) {
        EventEntryResult eventEntryResult = new EventEntryResult()
