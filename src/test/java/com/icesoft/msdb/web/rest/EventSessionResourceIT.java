...
/**
 * Integration tests for the {@link EventSessionResource} REST controller.
 */
@SpringBootTest(classes = MotorsportsDatabaseApp.class)
public class EventSessionResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static EventSession createUpdatedEntity(EntityManager em) {
        EventSession eventSession = new EventSession()
            .name(UPDATED_NAME)
