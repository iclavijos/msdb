...
/**
 * Integration tests for the {@link RacetrackResource} REST controller.
 */
@SpringBootTest(classes = MotorsportsDatabaseApp.class)
public class RacetrackResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Racetrack createUpdatedEntity(EntityManager em) {
        Racetrack racetrack = new Racetrack()
            .name(UPDATED_NAME)
