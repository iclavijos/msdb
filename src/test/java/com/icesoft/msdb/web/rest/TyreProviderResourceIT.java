...
/**
 * Integration tests for the {@link TyreProviderResource} REST controller.
 */
@SpringBootTest(classes = MotorsportsDatabaseApp.class)
public class TyreProviderResourceIT {
    ...
    private static final String DEFAULT_LETTER_COLOR = "AAAAAAAAAA";
    private static final String UPDATED_LETTER_COLOR = "BBBBBBBBBB";
     ...
     * if they test an entity which requires the current entity.
     */
    public static TyreProvider createUpdatedEntity(EntityManager em) {
        TyreProvider tyreProvider = new TyreProvider()
            .name(UPDATED_NAME)
            .logo(UPDATED_LOGO)
            .logoContentType(UPDATED_LOGO_CONTENT_TYPE)
            .letterColor(UPDATED_LETTER_COLOR)
    ...
    public void createTyreProvider() throws Exception {
        ...
        assertThat(testTyreProvider.getLetterColor()).isEqualTo(DEFAULT_LETTER_COLOR);
        assertThat(testTyreProvider.getBackgroundColor()).isEqualTo(DEFAULT_BACKGROUND_COLOR);
    ...
    @Test
    @Transactional
    public void checkLetterColorIsRequired() throws Exception {
        int databaseSizeBeforeTest = tyreProviderRepository.findAll().size();
        // set the field null
        tyreProvider.setLetterColor(null);
    ...
    public void checkBackgroundColorIsRequired() throws Exception {
        int databaseSizeBeforeTest = tyreProviderRepository.findAll().size();
        // set the field null
        tyreProvider.setBackgroundColor(null);
    ...
    public void getAllTyreProviders() throws Exception {
        ...
        restTyreProviderMockMvc.perform(get("/api/tyre-providers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].letterColor").value(hasItem(DEFAULT_LETTER_COLOR)))
    ...
    public void getTyreProvider() throws Exception {
        ...
        restTyreProviderMockMvc.perform(get("/api/tyre-providers/{id}", tyreProvider.getId()))
            ...
            .andExpect(jsonPath("$.letterColor").value(DEFAULT_LETTER_COLOR))
    ...
    public void updateTyreProvider() throws Exception {
        ...
        assertThat(testTyreProvider.getLetterColor()).isEqualTo(UPDATED_LETTER_COLOR);
        assertThat(testTyreProvider.getBackgroundColor()).isEqualTo(UPDATED_BACKGROUND_COLOR);
