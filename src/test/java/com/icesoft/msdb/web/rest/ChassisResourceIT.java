...
/**
 * Integration tests for the {@link ChassisResource} REST controller.
 */
@SpringBootTest(classes = MotorsportsDatabaseApp.class)
public class ChassisResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Chassis createUpdatedEntity(EntityManager em) {
        Chassis chassis = new Chassis()
            .name(UPDATED_NAME)
