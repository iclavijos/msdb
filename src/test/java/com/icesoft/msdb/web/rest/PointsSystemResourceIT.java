...
/**
 * Integration tests for the {@link PointsSystemResource} REST controller.
 */
@SpringBootTest(classes = MotorsportsDatabaseApp.class)
public class PointsSystemResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static PointsSystem createUpdatedEntity(EntityManager em) {
        PointsSystem pointsSystem = new PointsSystem()
            .name(UPDATED_NAME)
