...
/**
 * Integration tests for the {@link SeriesEditionResource} REST controller.
 */
@SpringBootTest(classes = MotorsportsDatabaseApp.class)
public class SeriesEditionResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static SeriesEdition createUpdatedEntity(EntityManager em) {
        SeriesEdition seriesEdition = new SeriesEdition()
