...
describe('Service Tests', () => {
    describe('EventEntryResult Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a EventEntryResult', async () => {
            ...
            it('should update a EventEntryResult', async () => {
                const returnedFromService = Object.assign(
                    {
                        finalPosition: 1,
                        totalTime: 1,
            ...
            it('should return a list of EventEntryResult', async () => {
                const returnedFromService = Object.assign(
                    {
                        finalPosition: 1,
                        totalTime: 1,
            ...
            it('should delete a EventEntryResult', async () => {
