...
import { ChassisComponent } from 'app/entities/chassis/chassis.component';
import { ChassisService } from 'app/entities/chassis/chassis.service';
import { Chassis } from 'app/shared/model/chassis.model';

describe('Component Tests', () => {
    describe('Chassis Management Component', () => {
        let comp: ChassisComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ChassisComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.chassis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
