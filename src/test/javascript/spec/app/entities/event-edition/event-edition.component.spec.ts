...
import { EventEditionComponent } from 'app/entities/event-edition/event-edition.component';
...
describe('Component Tests', () => {
  describe('EventEdition Management Component', () => {
    let comp: EventEditionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EventEditionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.eventEditions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
