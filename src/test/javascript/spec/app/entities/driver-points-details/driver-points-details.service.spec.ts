...
describe('Service Tests', () => {
    describe('DriverPointsDetails Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DriverPointsDetailsService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new DriverPointsDetails(0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a DriverPointsDetails', async () => {
                ...
                service
                    .create(new DriverPointsDetails(null))
                    .pipe(take(1))
            ...
            it('should update a DriverPointsDetails', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
            ...
            it('should return a list of DriverPointsDetails', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
                const expected = Object.assign({}, returnedFromService);
                service
                    .query(expected)
            ...
            it('should delete a DriverPointsDetails', async () => {
