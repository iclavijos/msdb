...
import { RacetrackComponent } from 'app/entities/racetrack/racetrack.component';
...
describe('Component Tests', () => {
  describe('Racetrack Management Component', () => {
    let comp: RacetrackComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RacetrackComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.racetracks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
