...
import { PointsSystemComponent } from 'app/entities/points-system/points-system.component';
...
describe('Component Tests', () => {
    describe('PointsSystem Management Component', () => {
        let comp: PointsSystemComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PointsSystemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.pointsSystems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
