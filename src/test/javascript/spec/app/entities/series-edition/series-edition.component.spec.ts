...
import { SeriesEditionComponent } from 'app/entities/series-edition/series-edition.component';
...
describe('Component Tests', () => {
  describe('SeriesEdition Management Component', () => {
    let comp: SeriesEditionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SeriesEditionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.seriesEditions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
