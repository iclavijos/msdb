...
export class SeriesEditionManufacturersChampionsDialogComponent implements OnInit {
  ...
  save() {
    ...
    this.seriesEditionService
      .setDriversChampions(this.seriesEditionId, this.selectedIds)
...
export class SeriesEditionManufacturersChampionsPopupComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.routeSub = this.route.params.subscribe(params => {
      this.seriesEditionPopupService.openDriversChamps(SeriesEditionManufacturersChampionsDialogComponent as Component, params['id']);
    });
  }
