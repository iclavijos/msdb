...
export class Calendar implements OnInit {
  ...
  constructor(private _translateService: TranslateService, private eventEditionService: EventEditionService, private http: Http) {}
  ...
  loadEvents(e) {
    ...
    this.eventEditionService.findCalendarEvents(start, end).subscribe(events => {
      this.convertEvents(events, this.timezone);
    });
  }
