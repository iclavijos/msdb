...
import { TyreProviderService } from '../../entities/tyre-provider/tyre-provider.service';
...
export class EventEntryUpdateComponent implements OnInit {
  ...
  displayFnDrivers(driver?: any): string | undefined {
    return driver ? driver.fullName as string : undefined;
  }

  displayFnTeams(team?: any): string | undefined {
    return team ? team.name as string : undefined;
  }

  displayFnChassis(chassis?: any): string | undefined {
    return chassis ? `${chassis.manufacturer as string} ${chassis.name as string}` : undefined;
  }

  displayFnEngines(engine?: any): string | undefined {
    return engine ? `${engine.manufacturer as string} ${engine.name as string}` : undefined;
  }

  displayFnTyres(tyres?: any): string | undefined {
    return tyres ? tyres.name as string : undefined;
  }

  displayFnFuel(fuel?: any): string | undefined {
    return fuel ? fuel.name as string : undefined;
  }
  ...
  setFileData(event, field: string, isImage) {
    return new Promise((resolve, reject) => {
      ...
      () => { console.log('Blob loaded')}, // success
      this.onError
    );
  }
