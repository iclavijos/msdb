...
export class ChassisComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['name', 'manufacturer'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IChassis[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
