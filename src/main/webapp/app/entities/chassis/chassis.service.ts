...
export class ChassisService {
  public resourceUrl = `${SERVER_API_URL as string}api/chassis`;
  public resourceSearchUrl = `${SERVER_API_URL as string}api/_typeahead/chassis`;
  public statsSearchUrl = `${SERVER_API_URL as string}api/stats/chassis`;
