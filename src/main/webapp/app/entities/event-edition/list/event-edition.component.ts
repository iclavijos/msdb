...
export class EventEditionComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['shortEventName', 'longEventName'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  delete(eventEdition: IEventEdition): void {
  ...
  protected onSuccess(data: IEventEdition[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
