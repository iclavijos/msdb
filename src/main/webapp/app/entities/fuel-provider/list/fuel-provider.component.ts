...
export class FuelProviderComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['name', 'logo'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  delete(fuelProvider: IFuelProvider): void {
  ...
  protected onSuccess(data: IFuelProvider[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
