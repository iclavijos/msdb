...
export class SeriesEditionComponent implements OnInit {
  ...
  constructor(
    protected seriesService: SeriesEditionService,
  ...
  delete(seriesEdition: ISeriesEdition): void {
  ...
  protected sort(): string[] {
    const result = [`${String(this.predicate)},${String(this.ascending ? ASC : DESC)}`];
  ...
  protected onSuccess(data: ISeriesEdition[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
