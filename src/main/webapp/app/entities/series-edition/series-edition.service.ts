...
export class SeriesEditionService {
  public resourceUrl = `${String(SERVER_API_URL)}api/series-editions`;
  public seriesResourceUrl = `${String(SERVER_API_URL)}api/series`;
  public resourceSearchUrl = `${String(SERVER_API_URL)}api/_search/series-editions`;
