...
export class RacetrackComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['name', 'location', 'logo'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  delete(racetrack: IRacetrack): void {
  ...
  protected onSuccess(data: IRacetrack[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
