...
export class EngineComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['name', 'manufacturer', 'architecture', 'image'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IEngine[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
