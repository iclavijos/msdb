...
export class PointsSystemComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['name', 'description', 'points'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  delete(pointsSystem: IPointsSystem): void {
  ...
  protected onSuccess(data: IPointsSystem[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
