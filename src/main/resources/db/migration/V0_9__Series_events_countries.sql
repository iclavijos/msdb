...
alter table msdb.event_entry_result add column laps_led integer;

alter table msdb.racetrack add column country_code varchar(2) not null;
alter table msdb.racetrack add column time_zone varchar(255);
